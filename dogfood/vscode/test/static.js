...
assert.equal(commands.size, 15, '0.1.4 command surface count changed unexpectedly');
...
console.log('VS-CODE-DOGFOOD-STATIC PASS commands=15 productP1P4=sealed lmDiscoveryGeneration=0 exactLunaOnly=yes doctorModelCalls=0 gitSafety=read-only consentBypass=no bundledCore=generated compiledProvider=not-implemented');
